...
```sh
curl -LO https://github.com/bguruprasad/k9s-lite/releases/download/v0.11.0/k9s-lite.dist.sh
...
- On Windows, PowerShell **does** use the system proxy:
  ...
  ```powershell
  Invoke-WebRequest -Uri https://github.com/bguruprasad/k9s-lite/releases/download/v0.11.0/k9s-lite.dist.sh -OutFile k9s-lite.dist.sh
  ```
